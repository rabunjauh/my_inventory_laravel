  ...
  <div class="row">
    <div class="col-md-5">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('name')is-invalid @enderror" id="name" name="name" value="{{ old('name', $department->name) }}" placeholder="Department Name" required autofocus>
        @error('name')
      ...
      <div class="mb-3">
        ...
        @if(old('group', $department->group) == "0")
          <div class="form-check form-check-inline">
