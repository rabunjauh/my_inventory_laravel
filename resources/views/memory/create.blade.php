  ...
  <div class="row">
    <div class="col-md-5">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('type')is-invalid @enderror" id="type" name="type" value="{{ old('type') }}" placeholder="Memory Type" required autofocus>
        @error('type')
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('module')is-invalid @enderror" id="module" name="module" value="{{ old('module') }}" placeholder="Module" required autofocus>
        @error('module')
        <div class="invalid-feedback">
          {{ $message }}
        </div>
